...
# recommend
# GLOBAL
FACTOR_TRAVEL_CREATE_GLOBAL = 10  # 游记发布影响因子
FACTOR_TRAVEL_READ_GLOBAL = 1  # 游记阅读影响因子
FACTOR_TRAVEL_LIKE_GLOBAL = 5  # 游记喜欢数
FACTOR_TRAVEL_COMMENT_GLOBAL = 3  # 游记评论数
FACTOR_PLAN_GLOBAL = 5  # 加入出行计划数
FACTOR_COMPANION_CREATE_GLOBAL = 5
FACTOR_COMPANION_PARTICIPATE_GLOBAL = 5
FACTOR_FLIGHT = 50
# USER
FACTOR_TRAVEL_CREATE_USER = 10
FACTOR_TRAVEL_READ_USER = 1  # 游记阅读影响因子
FACTOR_TRAVEL_LIKE_USER = 20  # 游记喜欢数
FACTOR_TRAVEL_COMMENT_USER = 3  # 游记评论数
FACTOR_PLAN_USER = 10
FACTOR_COMPANION_PARTICIPATE_USER = 20
FACTOR_COMPANION_CREATE_USER = 20



TAG_FORBIDDEN_FALSE = 0
TAG_FORBIDDEN_TRUE = 1
TAG_FORBIDDEN_PENDING = 2
