...
class Address(models.Model):
    ...
    province_position = models.ForeignKey(Position, related_name='addresses_province', null=True, on_delete=models.SET_NULL)
    ...
    def create_address(cls, position):
        ...
        n, p, c, d, s, sn = addr['nation'], addr['province'], addr['city'], addr['district'], addr['street'], addr['street_number']
        ...
        address = Address.objects.create(name=pname, longitude=lon, latitude=lat, position_id=adcode, city_position_id=adcode_city, province_position_id=adcode_province,
